...
(function (global) {
  ...
  var CATALOG = {
    A1: { id: 'A1', kind: 'level', level: 'a1', name: 'A1 Complete Access', paise: 199900, label: '₹1,999', tier: 'A1 · Foundations', blurb: 'All A1 chapters' },
    A2: { id: 'A2', kind: 'level', level: 'a2', name: 'A2 Complete Access', paise: 299900, label: '₹2,999', tier: 'A2 · Aufbau', blurb: 'All A2 chapters' },
    B1: { id: 'B1', kind: 'level', level: 'b1', name: 'B1 Complete Access', paise: 399900, label: '₹3,999', tier: 'B1 · Mittelstufe', blurb: 'All B1 chapters' },
    B2: { id: 'B2', kind: 'level', level: 'b2', name: 'B2 Complete Access', paise: 499900, label: '₹4,999', tier: 'B2 · Oberstufe', blurb: 'All B2 chapters' },
    C1: { id: 'C1', kind: 'level', level: 'c1', name: 'C1 Complete Access', paise: 799900, label: '₹7,999', tier: 'C1 · Oberstufe', blurb: 'All C1 chapters' },
    C2: { id: 'C2', kind: 'level', level: 'c2', name: 'C2 Complete Access', paise: 899900, label: '₹8,999', tier: 'C2 · Großes Sprachdiplom', blurb: 'All C2 chapters' },
