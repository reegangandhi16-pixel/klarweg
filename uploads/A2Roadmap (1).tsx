...
const data: RoadmapData = {
  meta: {
    lang: "en",
    title: "A2 · Aufbau — Klarweg",
    description:
      "The complete A2 German journey for Hindi-speaking learners — 35 chapters, color-coded grammar, Goethe-aligned. Begin Chapter 1 free.",
    canonical: "https://klarweg.com/a2",
  },
  nav: {
    logo: { text: "Klarweg", href: "/", dot: true, ariaLabel: "Klarweg home" },
    links: [
      { label: "A1", href: "/a1" },
      { label: "A2", href: "/a2", active: true },
      { label: "B1", href: "/b1" },
      { label: "B2", href: "/b2" },
      { label: "C1", href: "/c1" },
      { label: "C2", href: "/c2" },
    ...
    cta: { label: "Begin free", href: "/a2/chapter-1" },
  },
  skillLabels: {
  ...
  levels: {
    a2: {
      ...
      hero: {
        ...
        headline: {
          prefix: "From ",
          accent: "einfache Sätze",
          suffix: " to connected, confident everyday German.",
        },
        lede:
          "A2 is where German starts to connect — the cases, the past, and the words that link your ideas. Thirty-five chapters of color-coded grammar, premium audio, and AI-corrected practice — built for Hindi-speaking learners, aligned to the Goethe-Zertifikat A2.",
        ctas: [
          { label: "Begin Chapter 1 — Free", href: "/a2/chapter-1", variant: "primary", arrow: true },
          { label: "See the full path", href: "#roadmap", variant: "secondary", arrow: false },
        ],
      },
      heroStats: [
        { num: "35", label: 'Chapters from <span class="de-italic">Wiederholung</span> to <span class="de-italic">Goethe-Pr&uuml;fung</span>' },
        { num: "~20h", label: "Of structured learning, at your own pace" },
        { num: "4", label: "Thematic phases that build on each other" },
        { num: "1", label: "Free chapter — the full premium experience" },
      ],
      pathBand: {
        ariaLabel: "Four phases of A2",
        eyebrow: "The A2 Path",
        title: "Four phases. One clear arc.",
        note: "Each phase builds on the last. By the end, you can describe people and places, talk about the past, give advice, and connect your ideas in longer sentences.",
      },
      pathStations: [
        { num: "01–10", title: "Fundament & Brücke", meta: "Wiederholung → Vergleiche" },
        { num: "11–18", title: "Alltag, Ort & Bewegung", meta: "Dativ → werden" },
        { num: "19–25", title: "Fragen & Kommunikation", meta: "Indirekte Fragen → Konjunktiv II" },
        { num: "26–35", title: "Ausdruck & komplexe Sätze", meta: "Adjektive → Relativsätze" },
      ],
      roadmapIntro: {
        eyebrow: "The Roadmap",
        title: "The complete A2 journey.",
        body: "Chapter 1 is yours, no payment, no signup wall. The next 34 chapters unlock with the A2 bundle or Lifetime A1–C2.",
      },
      phases: [
        { eyebrow: "Phase 01", title: "Fundament & Brücke", range: [1, 10] },
        { eyebrow: "Phase 02", title: "Alltag, Ort & Bewegung", range: [11, 18] },
        { eyebrow: "Phase 03", title: "Fragen & Kommunikation", range: [19, 25] },
        { eyebrow: "Phase 04", title: "Ausdruck & komplexe Sätze", range: [26, 35] },
      ],
      chapters: [
        { id: "a2-1", n: 1, title: "Genitiv: Name + s", goal: "Show possession the everyday way — Annas Buch, Peters Auto — with the simple -s on names.", duration: "25 min", skills: ["audio", "grammar", "quiz", "pdf"], status: "free", cta: "Begin chapter", route: "/a2/chapter-1" },
        { id: "a2-2", n: 2, title: "Perfekt (Wiederholung)", goal: "Reactivate the spoken past — haben/sein plus Partizip II — until the two-part frame feels automatic again.", duration: "30 min", skills: ["grammar", "quiz", "speak", "pdf"], status: "locked", cta: "Unlock to begin", route: "/a2/chapter-2" },
        { id: "a2-3", n: 3, title: "Artikel (Wiederholung)", goal: "Refresh der, die, das across Nominativ, Akkusativ, and Dativ before the cases start carrying more weight.", duration: "30 min", skills: ["grammar", "quiz", "pdf"], status: "locked", cta: "Unlock to begin", route: "/a2/chapter-3" },
        { id: "a2-4", n: 4, title: "Nebensatz mit weil", goal: "Give reasons in a subordinate clause and send the conjugated verb all the way to the end.", duration: "30 min", skills: ["grammar", "quiz", "speak", "pdf"], status: "locked", cta: "Unlock to begin", route: "/a2/chapter-4" },
        { id: "a2-5", n: 5, title: "Nebensatz mit dass", goal: "Report thoughts and facts with dass — ich glaube, dass … — keeping verb-final word order.", duration: "30 min", skills: ["grammar", "quiz", "speak", "pdf"], status: "locked", cta: "Unlock to begin", route: "/a2/chapter-5" },
        { id: "a2-6", n: 6, title: "Modalverben im Präteritum", goal: "Talk about what you could, had to, and wanted to do with konnte, musste, and wollte.", duration: "30 min", skills: ["grammar", "quiz", "speak", "pdf"], status: "locked", cta: "Unlock to begin", route: "/a2/chapter-6" },
        { id: "a2-7", n: 7, title: "Possessivartikel im Dativ", goal: "Bend mein, dein, sein into the Dativ — mit meinem Bruder, von deiner Schwester.", duration: "30 min", skills: ["grammar", "quiz", "pdf"], status: "locked", cta: "Unlock to begin", route: "/a2/chapter-7" },
        { id: "a2-8", n: 8, title: "Komparativ & Superlativ", goal: "Compare and rank — schnell, schneller, am schnellsten — including the common irregular forms.", duration: "30 min", skills: ["grammar", "quiz", "speak", "pdf"], status: "locked", cta: "Unlock to begin", route: "/a2/chapter-8" },
        { id: "a2-9", n: 9, title: "Vergleiche mit als / wie", goal: "Say bigger than and as big as correctly — größer als, so groß wie — without mixing them up.", duration: "25 min", skills: ["audio", "grammar", "speak", "pdf"], status: "locked", cta: "Unlock to begin", route: "/a2/chapter-9" },
        { id: "a2-10", n: 10, title: "Goethe Mini 1", goal: "A short Goethe-style checkpoint covering every topic in Phase 1.", duration: "40 min", skills: ["audio", "quiz", "pdf"], status: "locked", cta: "Unlock to begin", route: "/a2/chapter-10" },
        { id: "a2-11", n: 11, title: "Nebensatz mit wenn", goal: "Set conditions and recurring situations with wenn, sending the verb to the end of the clause.", duration: "30 min", skills: ["grammar", "quiz", "speak", "pdf"], status: "locked", cta: "Unlock to begin", route: "/a2/chapter-11" },
        { id: "a2-12", n: 12, title: "Reflexive Verben", goal: "Use reflexive verbs and pronouns naturally — ich freue mich, du wäschst dich.", duration: "30 min", skills: ["grammar", "quiz", "speak", "pdf"], status: "locked", cta: "Unlock to begin", route: "/a2/chapter-12" },
        { id: "a2-13", n: 13, title: "Präpositionen mit Dativ", goal: "Lock in the always-Dativ prepositions — mit, nach, bei, seit, von, zu, aus.", duration: "35 min", skills: ["audio", "grammar", "quiz", "pdf"], status: "locked", cta: "Unlock to begin", route: "/a2/chapter-13" },
        { id: "a2-14", n: 14, title: "Wechselpräpositionen", goal: "Master the two-way prepositions — Akkusativ for motion, Dativ for location.", duration: "35 min", skills: ["grammar", "quiz", "speak", "pdf"], status: "locked", cta: "Unlock to begin", route: "/a2/chapter-14" },
        { id: "a2-15", n: 15, title: "Positions- & Richtungsverben", goal: "Pair stellen/stehen, legen/liegen, setzen/sitzen with the right case and the right meaning.", duration: "35 min", skills: ["grammar", "quiz", "speak", "pdf"], status: "locked", cta: "Unlock to begin", route: "/a2/chapter-15" },
        { id: "a2-16", n: 16, title: "Ortsangaben: Präposition", goal: "Place things precisely in space — wo versus wohin — using exactly the right preposition.", duration: "30 min", skills: ["audio", "grammar", "quiz", "pdf"], status: "locked", cta: "Unlock to begin", route: "/a2/chapter-16" },
        { id: "a2-17", n: 17, title: "werden", goal: "Use werden to say what something becomes — and to talk about plans and predictions.", duration: "30 min", skills: ["grammar", "quiz", "speak", "pdf"], status: "locked", cta: "Unlock to begin", route: "/a2/chapter-17" },
        { id: "a2-18", n: 18, title: "Goethe Mini 2", goal: "A Goethe-style checkpoint across Phase 2 — prepositions, cases, place and movement.", duration: "40 min", skills: ["audio", "quiz", "pdf"], status: "locked", cta: "Unlock to begin", route: "/a2/chapter-18" },
        { id: "a2-19", n: 19, title: "Indirekte Frage (W-Frage & ob)", goal: "Ask politely and indirectly — Weißt du, wo …? and Ich frage mich, ob …", duration: "30 min", skills: ["grammar", "quiz", "speak", "pdf"], status: "locked", cta: "Unlock to begin", route: "/a2/chapter-19" },
        { id: "a2-20", n: 20, title: "Interrogativartikel: was für ein(e)", goal: "Ask what kind of with was für ein(e) and read the case straight from the noun.", duration: "25 min", skills: ["grammar", "quiz", "pdf"], status: "locked", cta: "Unlock to begin", route: "/a2/chapter-20" },
        { id: "a2-21", n: 21, title: "Verben mit Dativ und Akkusativ", goal: "Handle verbs that take two objects — geben, schenken, zeigen — and order them correctly.", duration: "30 min", skills: ["grammar", "quiz", "speak", "pdf"], status: "locked", cta: "Unlock to begin", route: "/a2/chapter-21" },
        { id: "a2-22", n: 22, title: "Konjunktiv II: könnte", goal: "Soften requests and float possibilities with könnte — könntest du mir helfen?", duration: "30 min", skills: ["grammar", "quiz", "speak", "pdf"], status: "locked", cta: "Unlock to begin", route: "/a2/chapter-22" },
        { id: "a2-23", n: 23, title: "Konjunktiv II: sollte (Ratschläge)", goal: "Give advice and recommendations with sollte — du solltest mehr schlafen.", duration: "25 min", skills: ["audio", "speak", "quiz", "pdf"], status: "locked", cta: "Unlock to begin", route: "/a2/chapter-23" },
        { id: "a2-24", n: 24, title: "deshalb & trotzdem", goal: "Link cause and contrast across main clauses with deshalb and trotzdem, keeping the verb in position two.", duration: "30 min", skills: ["grammar", "quiz", "speak", "pdf"], status: "locked", cta: "Unlock to begin", route: "/a2/chapter-24" },
        { id: "a2-25", n: 25, title: "Goethe Mini 3", goal: "A Goethe-style checkpoint across Phase 3 — questions, advice, and connectors.", duration: "40 min", skills: ["audio", "quiz", "pdf"], status: "locked", cta: "Unlock to begin", route: "/a2/chapter-25" },
        { id: "a2-26", n: 26, title: "Adjektiv nach bestimmtem Artikel", goal: "Add adjective endings after der, die, das — der große Hund — across the cases.", duration: "35 min", skills: ["grammar", "quiz", "speak", "pdf"], status: "locked", cta: "Unlock to begin", route: "/a2/chapter-26" },
        { id: "a2-27", n: 27, title: "Adjektiv nach unbestimmtem Artikel", goal: "Add the trickier endings after ein, eine, kein — ein großer Hund, eine kleine Stadt.", duration: "35 min", skills: ["grammar", "quiz", "speak", "pdf"], status: "locked", cta: "Unlock to begin", route: "/a2/chapter-27" },
        { id: "a2-28", n: 28, title: "Nebensatz mit als / wenn", goal: "Tell a past one-off from a repeated event — als for once, wenn for whenever.", duration: "30 min", skills: ["grammar", "quiz", "speak", "pdf"], status: "locked", cta: "Unlock to begin", route: "/a2/chapter-28" },
        { id: "a2-29", n: 29, title: "Indefinitpronomen", goal: "Use man, jemand, niemand, etwas, and nichts to talk about people and things in general.", duration: "25 min", skills: ["grammar", "quiz", "pdf"], status: "locked", cta: "Unlock to begin", route: "/a2/chapter-29" },
        { id: "a2-30", n: 30, title: "Verben mit Präpositionen", goal: "Learn verbs with fixed prepositions — warten auf, denken an — and the case each one takes.", duration: "35 min", skills: ["grammar", "quiz", "speak", "pdf"], status: "locked", cta: "Unlock to begin", route: "/a2/chapter-30" },
        { id: "a2-31", n: 31, title: "W-Frage mit Präpositionen", goal: "Ask about them with worauf and woran, auf wen and an wen — the wo- and da- forms.", duration: "30 min", skills: ["grammar", "quiz", "speak", "pdf"], status: "locked", cta: "Unlock to begin", route: "/a2/chapter-31" },
        { id: "a2-32", n: 32, title: "Konjunktiv II: Wünsche & Höflichkeit", goal: "Express wishes and polite requests with würde, hätte, and wäre — ich hätte gern …", duration: "30 min", skills: ["grammar", "quiz", "speak", "pdf"], status: "locked", cta: "Unlock to begin", route: "/a2/chapter-32" },
        { id: "a2-33", n: 33, title: "Relativsätze im Nominativ", goal: "Describe nouns with relative clauses in the Nominativ — der Mann, der dort wohnt.", duration: "30 min", skills: ["grammar", "quiz", "speak", "pdf"], status: "locked", cta: "Unlock to begin", route: "/a2/chapter-33" },
        { id: "a2-34", n: 34, title: "Relativsätze im Akkusativ", goal: "Extend relative clauses into the Akkusativ — der Film, den ich gesehen habe.", duration: "30 min", skills: ["grammar", "quiz", "speak", "pdf"], status: "locked", cta: "Unlock to begin", route: "/a2/chapter-34" },
        { id: "a2-35", n: 35, title: "Goethe A2 Final", goal: "Full Goethe-Zertifikat A2 mock — Hören, Lesen, Schreiben, Sprechen — with review.", duration: "90 min", skills: ["audio", "speak", "quiz", "pdf"], status: "locked", cta: "Unlock to begin", route: "/a2/chapter-35" },
      ],
      learnLoop: {
        ariaLabel: "How an A2 chapter works",
      ...
      pricing: {
        ...
        intro: "Pay once for A2, or unlock the entire CEFR ladder with Lifetime. Chapter 1 stays free either way.",
        cards: [
          {
            tier: "A2 · Aufbau",
            price: "₹1,999",
            priceStrike: null,
            sub: "One-time. Lifetime access to A2.",
            center: false,
            features: [
              "All 35 A2 chapters unlocked",
              ...
              "Klarweg A2 certificate on completion",
            ],
            cta: { label: "Unlock A2", href: "/a2/checkout", variant: "secondary", arrow: true },
          },
          {
            tier: "Lifetime · A1 → C2",
            price: "₹4,999",
      ...
      finalCta: {
        ...
        body: "Pick up where A1 left off — with the cases, the past tense, and the connectors that turn single sentences into real, flowing German.",
        ctas: [
          { label: "Begin Chapter 1 — Free", href: "/a2/chapter-1", variant: "primary", arrow: true },
...
function ChapterCard({
  ...
  const ariaLabel = isLocked
    ? "Chapter " + chapter.n + ": " + chapter.title + ". Locked. Unlock with A1 bundle or Lifetime."
...
/*  Page                                                               */
/* ------------------------------------------------------------------ */
export default function A2Roadmap() {
  const level = data.levels.a2;
