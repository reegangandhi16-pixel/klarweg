...
const data: RoadmapData = {
  meta: {
    lang: "en",
    title: "C1 · Oberstufe — Klarweg",
    description:
      "The complete C1 German journey for Hindi-speaking learners — 43 chapters, color-coded grammar, Goethe-aligned. Begin Chapter 1 free.",
    canonical: "https://klarweg.com/c1",
  },
  nav: {
    ...
    links: [
      ...
      { label: "B1", href: "/b1" },
      { label: "B2", href: "/b2" },
      { label: "C1", href: "/c1", active: true },
      { label: "C2", href: "/c2" },
      { label: "Method", href: "/method" },
      { label: "Pricing", href: "/pricing" },
    ],
    cta: { label: "Begin free", href: "/c1/chapter-1" },
  },
  skillLabels: {
  ...
  levels: {
    c1: {
      ...
      hero: {
        ...
        headline: {
          prefix: "From ",
          accent: "präzise Sätze",
          suffix: " to nuanced, academic, near-native German.",
        },
        lede:
          "C1 is where German becomes truly your own — the nominal style of academic writing, the full range of Konjunktiv, extended participial attributes, and the stylistic control to argue, summarize, and write for university and career. Forty-three chapters of color-coded grammar, premium audio, and AI-corrected practice — built for Hindi-speaking learners, aligned to the Goethe-Zertifikat C1.",
        ctas: [
          { label: "Begin Chapter 1 — Free", href: "/c1/chapter-1", variant: "primary", arrow: true },
          { label: "See the full path", href: "#roadmap", variant: "secondary", arrow: false },
        ],
      },
      heroStats: [
        { num: "43", label: 'Chapters from <span class="de-italic">Tempusgebrauch</span> to <span class="de-italic">Goethe-Pr&uuml;fung</span>' },
        { num: "~25h", label: "Of structured learning, at your own pace" },
        { num: "7", label: "Thematic phases that build on each other" },
        { num: "1", label: "Free chapter — the full premium experience" },
      ],
      pathBand: {
        ariaLabel: "Seven phases of C1",
        eyebrow: "The C1 Path",
        title: "Seven phases. One clear arc.",
        note: "Each phase builds on the last. By the end, you can write in a precise nominal style, command every form of Konjunktiv and the passive, build complex noun phrases, and argue and summarize in academic German — ready for the Goethe-Zertifikat C1.",
      },
      pathStations: [
        { num: "01–06", title: "Präzise Satzarchitektur", meta: "Tempusgebrauch → Goethe Mini 1" },
        { num: "07–11", title: "Kasus & Präpositionen meistern", meta: "Genitivpräpositionen → Goethe Mini 2" },
        { num: "12–17", title: "Modalität, Konjunktiv & Wiedergabe", meta: "Modalverben → Halbzeit-Test" },
        { num: "18–23", title: "Attribute & komplexe Nominalgruppen", meta: "Adjektivdeklination → Goethe Mini 3" },
        { num: "24–28", title: "Nominalstil & Passiv", meta: "Nominalisierung → Goethe Mini 4" },
        { num: "29–33", title: "Stilistischer Feinschliff", meta: "Verben mit Präfixen → Goethe Mini 5" },
        { num: "34–43", title: "C1-Kompetenz & Goethe C1 Schreiben", meta: "Argumentieren → Goethe C1 Final" },
      ],
      roadmapIntro: {
        eyebrow: "The Roadmap",
        title: "The complete C1 journey.",
        body: "Chapter 1 is yours, no payment, no signup wall. The next 42 chapters unlock with the C1 bundle or Lifetime A1–C2.",
      },
      phases: [
        { eyebrow: "Phase 01", title: "Präzise Satzarchitektur", range: [1, 6] },
        { eyebrow: "Phase 02", title: "Kasus & Präpositionen meistern", range: [7, 11] },
        { eyebrow: "Phase 03", title: "Modalität, Konjunktiv & Wiedergabe", range: [12, 17] },
        { eyebrow: "Phase 04", title: "Attribute & komplexe Nominalgruppen", range: [18, 23] },
        { eyebrow: "Phase 05", title: "Nominalstil & Passiv", range: [24, 28] },
        { eyebrow: "Phase 06", title: "Stilistischer Feinschliff", range: [29, 33] },
        { eyebrow: "Phase 07", title: "C1-Kompetenz & Goethe C1 Schreiben", range: [34, 43] },
      ],
      chapters: [
        { id: "c1-1", n: 1, title: "Tempusgebrauch & stilistische Zeitformen", goal: "Choose the right past for the register — Präteritum in writing, Perfekt in speech — and switch tenses cleanly inside one text.", duration: "30 min", skills: ["audio", "grammar", "quiz", "pdf"], status: "free", cta: "Begin chapter", route: "/c1/chapter-1" },
        { id: "c1-2", n: 2, title: "Raum & Zeit präzise ausdrücken", goal: "Pin down place and time with the right preposition and case — an, auf, in, seit, innerhalb — without guessing.", duration: "30 min", skills: ["grammar", "quiz", "speak", "pdf"], status: "locked", cta: "Unlock to begin", route: "/c1/chapter-2" },
        { id: "c1-3", n: 3, title: "Nebensätze sicher beherrschen", goal: "Subordinate a thought and land the verb at the very end — weil, dass, obwohl — even across long clauses.", duration: "30 min", skills: ["grammar", "quiz", "speak", "pdf"], status: "locked", cta: "Unlock to begin", route: "/c1/chapter-3" },
        { id: "c1-4", n: 4, title: "Hauptsätze elegant verbinden", goal: "Link main clauses from position 0 and 1 — denn, deshalb, jedoch — and keep the verb second.", duration: "30 min", skills: ["grammar", "quiz", "speak", "pdf"], status: "locked", cta: "Unlock to begin", route: "/c1/chapter-4" },
        { id: "c1-5", n: 5, title: "Zweiteilige Satzverbindungen", goal: "Join ideas in pairs — entweder – oder, zwar – aber, je – desto — the balanced connectors of polished German.", duration: "30 min", skills: ["grammar", "quiz", "speak", "pdf"], status: "locked", cta: "Unlock to begin", route: "/c1/chapter-5" },
        { id: "c1-6", n: 6, title: "Goethe Mini 1", goal: "A short Goethe-style checkpoint covering every topic in Phase 1.", duration: "40 min", skills: ["audio", "quiz", "pdf"], status: "locked", cta: "Unlock to begin", route: "/c1/chapter-6" },
        { id: "c1-7", n: 7, title: "Präpositionen mit Genitiv", goal: "Use the formal Genitiv prepositions — trotz, aufgrund, mittels, angesichts — the register of academic German.", duration: "30 min", skills: ["grammar", "quiz", "speak", "pdf"], status: "locked", cta: "Unlock to begin", route: "/c1/chapter-7" },
        { id: "c1-8", n: 8, title: "Anspruchsvolle Präpositionen", goal: "Master the tricky ones — Wechselpräpositionen and rarer forms — and choose Akkusativ or Dativ on purpose.", duration: "30 min", skills: ["grammar", "quiz", "speak", "pdf"], status: "locked", cta: "Unlock to begin", route: "/c1/chapter-8" },
        { id: "c1-9", n: 9, title: "Adjektive mit präpositionalem Kasus", goal: "Combine adjectives with their fixed prepositions — stolz auf, fähig zu, abhängig von — and the case each demands.", duration: "30 min", skills: ["grammar", "quiz", "speak", "pdf"], status: "locked", cta: "Unlock to begin", route: "/c1/chapter-9" },
        { id: "c1-10", n: 10, title: "Nomen mit präpositionalem Objekt", goal: "Pair nouns with their prepositions — die Frage nach, der Grund für, das Interesse an — naturally.", duration: "30 min", skills: ["audio", "grammar", "quiz", "pdf"], status: "locked", cta: "Unlock to begin", route: "/c1/chapter-10" },
        { id: "c1-11", n: 11, title: "Goethe Mini 2", goal: "A Goethe-style checkpoint across Phase 2 — case precision and prepositional combinations.", duration: "40 min", skills: ["audio", "quiz", "pdf"], status: "locked", cta: "Unlock to begin", route: "/c1/chapter-11" },
        { id: "c1-12", n: 12, title: "Modalverben präzise verwenden", goal: "Use modal verbs with precision — objective meaning and tense — before the subjective leaps.", duration: "30 min", skills: ["grammar", "quiz", "speak", "pdf"], status: "locked", cta: "Unlock to begin", route: "/c1/chapter-12" },
        { id: "c1-13", n: 13, title: "Vermutungen mit Modalverben ausdrücken", goal: "Express degrees of certainty — er muss / dürfte / könnte zu Hause sein — the subjective use of modals.", duration: "30 min", skills: ["grammar", "quiz", "speak", "pdf"], status: "locked", cta: "Unlock to begin", route: "/c1/chapter-13" },
        { id: "c1-14", n: 14, title: "Konjunktiv II für Irreales & Hypothesen", goal: "Build the unreal — wenn ich Zeit hätte, würde ich – for hypotheses, wishes, and politeness.", duration: "35 min", skills: ["grammar", "quiz", "speak", "pdf"], status: "locked", cta: "Unlock to begin", route: "/c1/chapter-14" },
        { id: "c1-15", n: 15, title: "Konjunktiv I & indirekte Rede", goal: "Report what others say — er sei, er habe, er komme — the reporting subjunctive of news and academic German.", duration: "35 min", skills: ["grammar", "quiz", "speak", "pdf"], status: "locked", cta: "Unlock to begin", route: "/c1/chapter-15" },
        { id: "c1-16", n: 16, title: "Aufforderung, Empfehlung & indirekte Handlungssteuerung", goal: "Direct, advise, and suggest — Imperativ, sollten, es wäre ratsam, man könnte — across every register.", duration: "30 min", skills: ["audio", "grammar", "quiz", "pdf"], status: "locked", cta: "Unlock to begin", route: "/c1/chapter-16" },
        { id: "c1-17", n: 17, title: "Goethe Halbzeit-Test", goal: "A mid-course Goethe-style mock across Phases 1–3 — Lesen, Hören, Schreiben, and Sprechen.", duration: "60 min", skills: ["audio", "quiz", "pdf"], status: "locked", cta: "Unlock to begin", route: "/c1/chapter-17" },
        { id: "c1-18", n: 18, title: "Adjektivdeklination sicher anwenden", goal: "Get every adjective ending right — after der, ein, and no article — in any case.", duration: "30 min", skills: ["grammar", "quiz", "speak", "pdf"], status: "locked", cta: "Unlock to begin", route: "/c1/chapter-18" },
        { id: "c1-19", n: 19, title: "Steigerung & sprachliche Abstufung", goal: "Compare and grade with control — älter, am höchsten — and add nuance with weitaus, deutlich, bei weitem.", duration: "30 min", skills: ["grammar", "quiz", "speak", "pdf"], status: "locked", cta: "Unlock to begin", route: "/c1/chapter-19" },
        { id: "c1-20", n: 20, title: "Relativsätze erweitern und variieren", goal: "Stretch relative clauses — Genitiv dessen/deren, prepositional, and nested — without losing a verb.", duration: "35 min", skills: ["grammar", "quiz", "speak", "pdf"], status: "locked", cta: "Unlock to begin", route: "/c1/chapter-20" },
        { id: "c1-21", n: 21, title: "Partizipialattribute verstehen und nutzen", goal: "Pack a clause before a noun — das lesende Kind, der gelesene Text — the hallmark of written German.", duration: "35 min", skills: ["grammar", "quiz", "speak", "pdf"], status: "locked", cta: "Unlock to begin", route: "/c1/chapter-21" },
        { id: "c1-22", n: 22, title: "Komplexe Attribute & Nominalgruppen", goal: "Read and build long noun phrases — article, extended attribute, noun, trailing Genitiv — with the thread intact.", duration: "30 min", skills: ["audio", "grammar", "quiz", "pdf"], status: "locked", cta: "Unlock to begin", route: "/c1/chapter-22" },
        { id: "c1-23", n: 23, title: "Goethe Mini 3", goal: "A Goethe-style checkpoint across Phase 4 — declension, attributes, and complex noun phrases.", duration: "40 min", skills: ["audio", "quiz", "pdf"], status: "locked", cta: "Unlock to begin", route: "/c1/chapter-23" },
        { id: "c1-24", n: 24, title: "Nominalisierung im formellen Stil", goal: "Turn verbs and adjectives into nouns — prüfen → die Prüfung — for the dense, formal style C1 expects.", duration: "35 min", skills: ["grammar", "quiz", "speak", "pdf"], status: "locked", cta: "Unlock to begin", route: "/c1/chapter-24" },
        { id: "c1-25", n: 25, title: "Partizipien & Adjektive als Nomen", goal: "Nominalize participles and adjectives — der Reisende, das Beste, ein Bekannter — and decline them right.", duration: "30 min", skills: ["grammar", "quiz", "speak", "pdf"], status: "locked", cta: "Unlock to begin", route: "/c1/chapter-25" },
        { id: "c1-26", n: 26, title: "Passiv & Passiversatzformen", goal: "Command the full passive — werden, sein zu, sich lassen, man — and switch between them on purpose.", duration: "35 min", skills: ["grammar", "quiz", "speak", "pdf"], status: "locked", cta: "Unlock to begin", route: "/c1/chapter-26" },
        { id: "c1-27", n: 27, title: "Funktionsverbgefüge im akademischen Deutsch", goal: "Master the set phrases of formal German — in Frage stellen, zur Verfügung stehen, in Betracht ziehen.", duration: "30 min", skills: ["audio", "grammar", "quiz", "pdf"], status: "locked", cta: "Unlock to begin", route: "/c1/chapter-27" },
        { id: "c1-28", n: 28, title: "Goethe Mini 4", goal: "A Goethe-style checkpoint across Phase 5 — nominal style and passive forms.", duration: "40 min", skills: ["audio", "quiz", "pdf"], status: "locked", cta: "Unlock to begin", route: "/c1/chapter-28" },
        { id: "c1-29", n: 29, title: "Verben mit Präfixen sicher unterscheiden", goal: "Tell trennbar from untrennbar and hear the meaning shift — úmschreiben vs. umschréiben.", duration: "30 min", skills: ["grammar", "quiz", "speak", "pdf"], status: "locked", cta: "Unlock to begin", route: "/c1/chapter-29" },
        { id: "c1-30", n: 30, title: "Nomen mit Numerus-Besonderheiten", goal: "Handle the nouns that break the rules — only singular, only plural, or a meaning that changes with number.", duration: "25 min", skills: ["grammar", "quiz", "speak", "pdf"], status: "locked", cta: "Unlock to begin", route: "/c1/chapter-30" },
        { id: "c1-31", n: 31, title: "Adversativangaben & Gegensätze ausdrücken", goal: "Set ideas against each other — jedoch, hingegen, dagegen, vielmehr — with precision and weight.", duration: "30 min", skills: ["grammar", "quiz", "speak", "pdf"], status: "locked", cta: "Unlock to begin", route: "/c1/chapter-31" },
        { id: "c1-32", n: 32, title: "Kohärenz & Textverknüpfung", goal: "Bind a text into one argument — folglich, demnach, darüber hinaus, nichtsdestotrotz — the connectors graders reward.", duration: "30 min", skills: ["audio", "grammar", "quiz", "pdf"], status: "locked", cta: "Unlock to begin", route: "/c1/chapter-32" },
        { id: "c1-33", n: 33, title: "Goethe Mini 5", goal: "A Goethe-style checkpoint across Phase 6 — refinement, contrast, and cohesion.", duration: "40 min", skills: ["audio", "quiz", "pdf"], status: "locked", cta: "Unlock to begin", route: "/c1/chapter-33" },
        { id: "c1-34", n: 34, title: "Argumentieren auf C1-Niveau", goal: "Build an argument that holds — These, Begründung, Beleg — the backbone of a C1 opinion text.", duration: "30 min", skills: ["grammar", "quiz", "speak", "pdf"], status: "locked", cta: "Unlock to begin", route: "/c1/chapter-34" },
        { id: "c1-35", n: 35, title: "Konzession & Abwägen", goal: "Concede and weigh — zwar – aber, einerseits – andererseits, zugegebenermaßen — then land your point.", duration: "30 min", skills: ["grammar", "quiz", "speak", "pdf"], status: "locked", cta: "Unlock to begin", route: "/c1/chapter-35" },
        { id: "c1-36", n: 36, title: "Register & Stilebenen beherrschen", goal: "Shift between formal, neutral, and informal on demand — and never mix the wrong register into an exam text.", duration: "30 min", skills: ["grammar", "quiz", "speak", "pdf"], status: "locked", cta: "Unlock to begin", route: "/c1/chapter-36" },
        { id: "c1-37", n: 37, title: "C1-Kollokationen & Bedeutungsnuancen", goal: "Pick the precise word — eine Entscheidung treffen, Kritik üben — and feel the nuance between near-synonyms.", duration: "30 min", skills: ["audio", "grammar", "quiz", "pdf"], status: "locked", cta: "Unlock to begin", route: "/c1/chapter-37" },
        { id: "c1-38", n: 38, title: "Zusammenfassung schreiben", goal: "Condense a source faithfully — report the key points in your own words, in the right register.", duration: "35 min", skills: ["grammar", "quiz", "speak", "pdf"], status: "locked", cta: "Unlock to begin", route: "/c1/chapter-38" },
        { id: "c1-39", n: 39, title: "Stellungnahme schreiben", goal: "Write a structured opinion — position, arguments, counter, conclusion — the core C1 writing task.", duration: "35 min", skills: ["grammar", "quiz", "speak", "pdf"], status: "locked", cta: "Unlock to begin", route: "/c1/chapter-39" },
        { id: "c1-40", n: 40, title: "Forumsbeitrag schreiben", goal: "Respond in a semi-formal online debate — react, argue, and address others — clearly and on topic.", duration: "30 min", skills: ["grammar", "quiz", "speak", "pdf"], status: "locked", cta: "Unlock to begin", route: "/c1/chapter-40" },
        { id: "c1-41", n: 41, title: "Grafikbeschreibung & Grafikauswertung", goal: "Describe and interpret data — trends, comparisons, and what the figures actually mean.", duration: "30 min", skills: ["audio", "grammar", "quiz", "pdf"], status: "locked", cta: "Unlock to begin", route: "/c1/chapter-41" },
        { id: "c1-42", n: 42, title: "Goethe-Zertifikat C1 — Probeprüfung", goal: "A full Goethe-style mock under real conditions — Lesen, Hören, Schreiben, Sprechen — to learn the exam.", duration: "90 min", skills: ["audio", "speak", "quiz", "pdf"], status: "locked", cta: "Unlock to begin", route: "/c1/chapter-42" },
        { id: "c1-43", n: 43, title: "Goethe-Zertifikat C1 — Final", goal: "Full Goethe-Zertifikat C1 mock — Hören, Lesen, Schreiben, Sprechen — with review.", duration: "90 min", skills: ["audio", "speak", "quiz", "pdf"], status: "locked", cta: "Unlock to begin", route: "/c1/chapter-43" },
      ],
      learnLoop: {
        ariaLabel: "How a C1 chapter works",
      ...
      pricing: {
        ...
        intro: "Pay once for C1, or unlock the entire CEFR ladder with Lifetime. Chapter 1 stays free either way.",
        cards: [
          {
            tier: "C1 · Oberstufe",
            price: "₹699",
            priceStrike: null,
            sub: "One-time. Lifetime access to C1.",
            center: false,
            features: [
              "All 43 C1 chapters unlocked",
              ...
              "Klarweg C1 certificate on completion",
            ],
            cta: { label: "Unlock C1", href: "/c1/checkout", variant: "secondary", arrow: true },
          },
          {
            tier: "Lifetime · A1 → C2",
            price: "₹1,999",
      ...
      finalCta: {
        title: "The first chapter is <em>free</em>. The next forty-two are waiting.",
        body: "Pick up where B2 left off — with the nominal style, the full Konjunktiv, extended attributes, and the stylistic precision that makes your German read like a native academic writer.",
        ctas: [
          { label: "Begin Chapter 1 — Free", href: "/c1/chapter-1", variant: "primary", arrow: true },
...
function ChapterCard({
  ...
  const ariaLabel = isLocked
    ? "Chapter " + chapter.n + ": " + chapter.title + ". Locked. Unlock with C1 bundle or Lifetime."
...
/*  Page                                                               */
/* ------------------------------------------------------------------ */
export default function C1Roadmap() {
  const level = data.levels.c1;
